  ...
  return (
    <div className="h-screen w-full flex bg-[#0A0A0F] text-neutral-200 overflow-hidden relative">
      ...
      <nav className="hidden md:flex w-16 flex-col items-center py-4 gap-1 border-r border-white/5 bg-gradient-to-b from-[#0F0F1A] via-[#0A0A0F] to-[#0A0A0F] relative z-10 shrink-0">
        ...
        {[
          { label: 'Home', active: true, d: 'M10.707 2.293a1 1 0 0 0-1.414 0l-7 7a1 1 0 0 0 1.414 1.414L4 10.414V17a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-3h2v3a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-6.586l.293.293a1 1 0 0 0 1.414-1.414l-7-7Z' },
          { label: 'Discover', d: 'M10 2a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm3.536 4.464-1.415 4.243a1 1 0 0 1-.638.638l-4.243 1.415a.5.5 0 0 1-.633-.633l1.415-4.243a1 1 0 0 1 .638-.638l4.243-1.415a.5.5 0 0 1 .633.633Z' },
          { label: 'Library', d: 'M3 3.5A1.5 1.5 0 0 1 4.5 2h3A1.5 1.5 0 0 1 9 3.5v13A1.5 1.5 0 0 1 7.5 18h-3A1.5 1.5 0 0 1 3 16.5v-13Zm8 0A1.5 1.5 0 0 1 12.5 2h3A1.5 1.5 0 0 1 17 3.5v13a1.5 1.5 0 0 1-1.5 1.5h-3a1.5 1.5 0 0 1-1.5-1.5v-13Z' },
          { label: 'Spaces', d: 'M2 4.75A2.75 2.75 0 0 1 4.75 2h10.5A2.75 2.75 0 0 1 18 4.75v10.5A2.75 2.75 0 0 1 15.25 18H4.75A2.75 2.75 0 0 1 2 15.25V4.75ZM6 6.5A1.5 1.5 0 0 1 7.5 5h5A1.5 1.5 0 0 1 14 6.5v7a1.5 1.5 0 0 1-1.5 1.5h-5A1.5 1.5 0 0 1 6 13.5v-7Z' },
        ].map((item) => (
          <button
            key={item.label}
            type="button"
      ...
      {/* ============ SIDEBAR ============ */}
      <aside className="hidden lg:flex lg:w-72 xl:w-80 flex-col border-r border-white/5 bg-gradient-to-b from-[#0D0D1A] via-[#0A0A14] to-[#08080F] relative z-10">
        {/* Header */}
        ...
        <nav className="flex-1 overflow-y-auto px-3 pb-3 space-y-1">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4 text-[#00D4FF] shrink-0">
              <path fillRule="evenodd" d="M2 4.25A2.25 2.25 0 0 1 4.25 2h11.5A2.25 2.25 0 0 1 18 4.25v8.5A2.25 2.25 0 0 1 15.75 15H9.06l-2.573 2.573A.75.75 0 0 1 5.25 17v-2H4.25A2.25 2.25 0 0 1 2 12.75v-8.5Z" clipRule="evenodd" />
            </svg>
          ...
          {[
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4 text-neutral-600 shrink-0">
                <path fillRule="evenodd" d="M2 4.25A2.25 2.25 0 0 1 4.25 2h11.5A2.25 2.25 0 0 1 18 4.25v8.5A2.25 2.25 0 0 1 15.75 15H9.06l-2.573 2.573A.75.75 0 0 1 5.25 17v-2H4.25A2.25 2.25 0 0 1 2 12.75v-8.5Z" clipRule="evenodd" />
              </svg>
      ...
      <div className="flex-1 flex flex-col min-w-0 relative z-10">
        ...
        {/* Top bar */}
        <header className="h-16 shrink-0 flex items-center justify-between px-4 md:px-6 border-b border-white/5 bg-[#0A0A0F]/80 backdrop-blur-md">
          <div className="flex items-center gap-3">
            <button type="button" className="lg:hidden text-neutral-400 hover:text-neutral-200">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <button type="button" className="text-neutral-500 hover:text-neutral-200 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                <path fillRule="evenodd" d="M10 2a6 6 0 0 0-6 6c0 1.887-.454 3.665-1.257 5.234a.75.75 0 0 0 .515 1.076 32.9 32.9 0 0 0 13.484 0 .75.75 0 0 0 .515-1.076A11.45 11.45 0 0 1 16 8a6 6 0 0 0-6-6ZM8.05 14.943a.75.75 0 0 0-1.1 1.02 3.5 3.5 0 0 0 6.1 0 .75.75 0 0 0-1.1-1.02 2 2 0 0 1-3.9 0Z" clipRule="evenodd" />
              </svg>
            </button>
          ...
          <div className="max-w-3xl mx-auto px-4 md:px-6 py-8 space-y-8">
            ...
            <div className="flex flex-col items-center justify-center text-center pt-16 pb-8">
              ...
              <h1 className="text-2xl font-semibold mb-2 bg-gradient-to-r from-neutral-50 via-neutral-200 to-neutral-400 bg-clip-text text-transparent">
                {user?.username ? `Welcome back, ${user.username}` : "Welcome to Omni Chat"}
              </h1>
              <p className="text-neutral-500 text-sm max-w-sm">
                Ask a question, paste a document, or pick up a past conversation from the sidebar.
              </p>

              <div className="flex flex-wrap items-center justify-center gap-2 mt-6">
                {["Summarize a document", "Compare technologies", "Debug my code", "Draft an email"].map((chip) => (
                  <button
                    key={chip}
                    type="button"
            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-neutral-300 mb-1">Omni</p>
                <div className="text-sm text-neutral-300 leading-relaxed rounded-2xl rounded-tl-sm bg-gradient-to-br from-white/[0.03] to-transparent ring-1 ring-white/5 px-4 py-3">
                  I can help you research, write, debug code, and reason through problems. What are you working on today?
                </div>
              </div>
            </div>
